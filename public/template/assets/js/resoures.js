            ...
            b = function() {
                function c(c, d) {
                    ...
                    e.defaults = {
                        ...
                        arrows: !0,
                        asNavFor: null,
                        prevArrow: '<button type="button" data-role="none" class="slick-prev" aria-label="Previous" tabindex="0" role="button"  style="font-size:18px">Previous <i class="fa fa-angle-left" style="color:#fff"></i></button>',
                        nextArrow: '<button type="button" data-role="none" class="slick-next" aria-label="Next" tabindex="0" role="button"  style="font-size:18px">Next <i class="fa fa-angle-right" style="color:#fff"></i></button>',
                        autoplay: !1,
                        autoplaySpeed: 3e3,
                        centerMode: !1,
                        centerPadding: "50px",
