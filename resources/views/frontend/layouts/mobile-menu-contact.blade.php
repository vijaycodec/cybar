...
<div class="mobile-menu2 mobile-menu3">
    <header class="mobile-nav-top ser-menu-top">
       ...
       <div class="mobile-logo">
          <a href="index.php"><img src="{{ asset('assets/images/cybarwind-logo.png') }}"></a>
       </div>
       <div class="ser-menu">
    ...
    <div class="mobile-ser-tab">
        <ul class="mobile-ser-menu">
           <li><a href="#mb-delhi">Delhi Head Office</a></li>
           <li><a href="#mb-Gurugram">Gurugram Office </a></li>
           <li><a href="#mb-To-Contact-Us">Contact Us</a></li>
