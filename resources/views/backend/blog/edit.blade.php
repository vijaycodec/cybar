    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>Edit Blog Sub Category Information</h3>
            ...
            <div class="wg-box">
                <form id="category-form" class="form-new-brand form-style-1"
                    action="{{ route('blog.update', $subcategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <a class="tf-button style-1 w208" style="padding-left: 75px;" href="{{ route('blog.list') }}">
                        Back</a>
                    <fieldset class="name">
            ...
            $('#category-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('blog.update', $subcategory->id) }}",
                            method: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
