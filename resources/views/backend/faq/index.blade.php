        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">All Faq</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href=" {{ route('faq.create') }}">
                        <i class="icon-plus"></i>Add New </a>
                </div>

                <div class="table-responsive">
                    <table id="faqsTable" class="table table-striped table-bordered " style="table-layout: auto;">
                        <thead>
                            <tr>
                                <th>ID</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <a href="{{ route('faq.edit', $category->id) }}">
                                                    <div class="item edit">
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('faq.destroy', ':id') }}".replace(':id', categoryId),
