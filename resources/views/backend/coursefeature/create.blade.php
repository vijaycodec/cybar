    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>CourseFeature infomation</h3>
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="#">
                            <div class="text-tiny">CourseFeature</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">New CourseFeature</div>
                    </li>
                </ul>
            </div>
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-brand form-style-1" action="{{ route('coursefeature.store') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <a class="tf-button style-1 w208" style="padding-left: 75px;"
                        href=" {{ route('coursefeature.list') }}">
                        Back</a>
                    <fieldset class="name">
