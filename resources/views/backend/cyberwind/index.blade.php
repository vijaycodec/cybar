        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    <li><a href="{{ route('admin.dashboard') }}">
                            <div class="text-tiny">Cyberwind</div>
                        </a></li>
                    <li><i class="icon-chevron-right"></i></li>
                    <li>
                        <div class="text-tiny">All Cyberwind</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href=" {{ route('cyberwind.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="list-icon-function">
                                                ...
                                                <a href="{{ route('cyberwind.edit', $category->id) }}">
                                                    <div class="item edit">
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('cyberwind.destroy', ':id') }}".replace(':id', categoryId),
