        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li><i class="icon-chevron-right"></i></li>
                    <li><div class="text-tiny">New Testimonials</div></li>
                </ul>
            </div>

            <div class="wg-box">
                <form class="form-new-brand form-style-1" action="{{ route('menutestimonial.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <a class="tf-button style-1 w208" style="padding-left: 75px;" href=" {{ route('menutestimonial.list') }}">
                        Back</a>
                        <fieldset class="name">
                    ...
                    <fieldset class="name">
                        <div class="body-title"> Testimonials Name <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Testimonials Name" name="user_name" tabindex="0"
                            value="{{ old('user_name') }}" aria-required="true" required="">
                    </fieldset>

                    <fieldset class="name">
                        <div class="body-title"> Designation <span class="tf-color-1">*</span></div>
                        <input class="flex-grow" type="text" placeholder="Designation" name="designation" tabindex="0"
                            value="{{ old('designation') }}" aria-required="true" required="">
                    </fieldset>
                    ...
                    <fieldset class="name">
                        ...
                        <textarea  class="flex-grow"  placeholder="Short Description" name="short_desc" tabindex="0"
