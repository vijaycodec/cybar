            ...
            <nav id="stacked-menu" class="stacked-menu">
              ...
              <ul class="menu">
			       <li class="menu-item ">
					...
					<li class="menu-item ">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Testimonials Details</span></a>
					</li>
					<li class="menu-item ">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Blogs Details</span></a>
					</li>
					<li class="menu-item">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Our Services Details</span></a>
					</li>
					<li class="menu-item ">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Corporate Training Details</span></a>
					</li>
					<li class="menu-item ">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Resources Details</span></a>
					</li>
					<li class="menu-item " class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Events Details</span></a>
					</li>
					<li class="menu-item ">
					  <a href="" class="menu-link"><span class="menu-icon"><i class="menu-icon oi oi-browser"></i></span> <span class="menu-text">Template l3 Details</span></a>
					</li>
