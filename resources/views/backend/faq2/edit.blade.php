        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li><a href="#">
                            <div class="text-tiny">Edit Faq2 </div>
                        </a></li>
                    <li><i class="icon-chevron-right"></i></li>
                    <li>
            ...
            <div class="wg-box">
                <form id="category-form" class="form-new-brand form-style-1"
                    action="{{ route('faq2.update', $l3Category->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <a class="tf-button style-1 w208" style="padding-left: 75px;" href="{{ route('faq2.list') }}">
                        Back</a>
            ...
            $('#category-form').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('faq2.update', $l3Category->id) }}",
                            method: "POST",
                            data: formData,
                            processData: false,
                            contentType: false,
