    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                <h3>News Latters Information</h3>
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li><a href="#"><div class="text-tiny">News Latters</div></a></li>
                    <li><i class="icon-chevron-right"></i></li>
                    <li><div class="text-tiny">New News Latters</div></li>
                </ul>
            </div>

            <div class="wg-box">
                <form class="form-new-brand form-style-1" action="{{ route('newsletter.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <a class="tf-button style-1 w208" style="padding-left: 75px;" href=" {{ route('newsletter.list') }}">
                        Back</a>
                    <fieldset class="name">
