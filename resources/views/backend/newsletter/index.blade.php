        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">All News Letters</div>
                    </li>
                </ul>
            </div>
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href=" {{ route('newsletter.create') }}">
                                        ...
                                        <td>
                                            @if ($newsletter->images)
                                                <img src="{{ asset('storage/uploads/backend/newsletter/' . $newsletter->images) }}"
                                                    alt="newsletter Image" width="100">
                                            @else
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete', function() {
                var newsletterId = $(this).data('id'); // Get ID from data attribute
                Swal.fire({
                    title: 'Are you sure?',
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('newsletter.destroy', ':id') }}".replace(':id',
                                newsletterId),
                            method: "DELETE",
                            data: {
